...
public class MqConst {
    ...
    public static final String EXCHANGE_DIRECT_ORDER_CANCEL_DEAD = "exchange.direct.order.cancel.dead";
    public static final String ROUTING_ORDER_CANCEL = "normal.order.cancel";
    public static final String ROUTING_ORDER_CANCEL_DEAD = "dead.order.cancel";
    //延迟取消订单队列
    public static final String QUEUE_ORDER_CANCEL  = "queue.order.cancel";
    public static final String QUEUE_ORDER_CANCEL_DEAD= "queue.order.cancel.dead";
    //取消订单 延迟时间 单位：秒
     ...
     * 取消秒杀订单，发送延迟队列
     */
    public static final String EXCHANGE_DIRECT_SECKILL_ORDER_CANCEL = "exchange.direct.seckill.order.cancel";
    public static final String EXCHANGE_DIRECT_SECKILL_ORDER_CANCEL_DEAD = "exchange.direct.seckill.order.cancel.dead";
    public static final String ROUTING_SECKILL_ORDER_CANCEL = "normal.seckill.order.cancel";
    public static final String ROUTING_SECKILL_ORDER_CANCEL_DEAD = "dead.seckill.order.cancel";
    //延迟取消订单队列
    public static final String QUEUE_SECKILL_ORDER_CANCEL  = "queue.seckill.order.cancel";
    public static final String QUEUE_SECKILL_ORDER_CANCEL_DEAD= "queue.seckill.order.cancel.dead";
     ...
     * 秒杀订单支付
     */
    public static final String EXCHANGE_DIRECT_SECKILL_PAYMENT_PAY = "exchange.direct.seckill.payment.pay";
    public static final String ROUTING_SECKILL_PAYMENT_PAY = "payment.seckill.pay";
    //队列
    public static final String QUEUE_SECKILL_PAYMENT_PAY  = "queue.seckill.payment.pay";
     ...
     * 减库为零，更新数据库信息
     */
    public static final String EXCHANGE_DIRECT_STORE_NONE = "exchange.direct.store.none";
    public static final String ROUTING_STORE_NONE = "store.none";
    //队列
    public static final String QUEUE_STORE_NONE  = "queue.store.none";
